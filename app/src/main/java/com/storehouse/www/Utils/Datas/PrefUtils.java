package com.storehouse.www.Utils.Datas;
...
public class PrefUtils {
    ...
    public static String getMemoryAccountString(String key){ return getString(BaseApplication.getInstance(),key,"{\"jsonaccount\":[]}"); }
